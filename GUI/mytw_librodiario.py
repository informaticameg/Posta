...
class MyTableWidgetLibroDiario():
    """
    Implementacion de MyTableWidget modificado para que agregue cada monto de un movimiento con color.
    """
    def __init__(self,TW,listadecolumnas, listadealineaciones = []):
        ...
        self.__widget.horizontalHeader().setDefaultSectionSize(450)
